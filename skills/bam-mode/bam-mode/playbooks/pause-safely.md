...
2. Make the pause idempotent. Apply the **principle-make-operations-idempotent** skill: if a pause artifact already exists, update or reference it instead of stacking duplicate WIP commits or competing resume notes.
