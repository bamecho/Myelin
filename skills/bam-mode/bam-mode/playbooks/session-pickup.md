...
1. Locate the prior trail from a path or URL supplied by the user or active
   host, a transcript explicitly scoped to the current workspace, a resume note,
   or a pushed branch. Never search global agent-history directories or
